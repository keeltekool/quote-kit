...
export function AppSidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-64 border-r border-border bg-white">
      <div className="p-6">
        <h1 className="text-xl font-bold text-foreground">QuoteKit</h1>
      </div>
...
// Minimal inline SVG icons to avoid a dependency
